...
export default function CardProduct({id, name, price,image, onClick}: CartProductType) {
    ...
    return (
        <Card
            ...
            renderImage={() => (
                <Image height={1000} width={1000} alt="" src={image}
                       className="rounded-t-md h-[210px] object-cover overflow-hidden"/>
            )}
        >
            ...
            <div className="flex items-center justify-between">
                ...
                <span className='flex justify-center items-center'>
                    ...
                    <button className={`ml-1 font-normal rounded-lg w-max text-white text-sm py-2 px-3 bg-gray-500`}
                            onClick={
